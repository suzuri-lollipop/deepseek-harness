...
- The General section carries exactly one shell-owned built-in row (the Android client download row); every other row appears only when its owning feature plugin is mounted.
